...
int main(int argc, char* argv[])
{
   ...
   do
   {
      ...
      case 'n': case 'N':
         ...
         {
         case 11:
            cout << is1.newToThis(is1) << " items in is1 are new to itself" << endl;
            break;
         case 12:
            cout << is1.newToThis(is2) << " items in is2 are new to is1" << endl;
            break;
         case 13:
            cout << is1.newToThis(is3) << " items in is3 are new to is1" << endl;
            break;
         case 21:
            cout << is2.newToThis(is1) << " items in is1 are new to is2" << endl;
            break;
         case 22:
            cout << is2.newToThis(is2) << " items in is2 are new to itself" << endl;
            break;
         case 23:
            cout << is2.newToThis(is3) << " items in is3 are new to is2" << endl;
            break;
         case 31:
            cout << is3.newToThis(is1) << " items in is1 are new to is3" << endl;
            break;
         case 32:
            cout << is3.newToThis(is2) << " items in is2 are new to is3" << endl;
            break;
         case 33:
            cout << is3.newToThis(is3) << " items in is3 are new to itself" << endl;
         }
         break;
      case 'r': case 'R':
         hybridNum = get_hybrid_num(argc);
...
void print_menu()
{
   ...
   cout << "  n  Query # of is1, is2 or is3 items new to is1, is2 or is3" << endl;
